# lines.py
# A central place for storing spectral line information.

# Dictionary of rest-frame vacuum wavelengths in Angstroms.
rest_lambdas = {
...
# Dictionary of Matplotlib-formatted r-strings for plotting labels.
line_labels = {
    # --- Primary [OIII] and [OII] ---
